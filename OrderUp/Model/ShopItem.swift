...
let shopItems: [ShopItem] = [
    ...
    ShopItem(category: "shoes", price: 47.99, id: 5, name: "Sidewalk Low-Top Sneaker", description: "Our sneakers were designed to be comfy from the get-go. Made of color-block leather, they have MWL Cloud-lift insoles for a super-cushy, ultra-supportive fit that feels like walking on a...well, you know.", imageName: "sidewalk"),
    ShopItem(category: "shoes", price: 110, id: 6, name: "Kickoff Trainer Sneakers", description: "Part old school and part new, our very first trainers have MWL Cloud-lift insoles for a super-cushy, ultra-supportive fit that feels like walking on a...well, you know.", imageName: "kickoff"),
    ...
    ShopItem(category: "dresses", price: 68, id: 10, name: "Puff Sleeve Button Front Midi Dress", description: "Lightweight woven fabric (with a subtle plaid pattern embossed throughout) creates a flattering V-neckline and a fitted bodice, framed by short puffy sleeves with elastic cuffs.", imageName: "white"),
